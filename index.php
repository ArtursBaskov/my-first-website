...
<div class="cd-full-width"> <!-- container js-tm-page-content tm-section-margin-t -->

  <div class="panel">

  </div>
<div class="BG">
  <div id="sear" class="search-f">
    <h class="search-h">Meklēt pilsētu</h>
    <form method="POST" id="ser-form">
      <div class="ser-cont">
        <input type="text" name="search" id="serF">
        <button type="submit" name="search-btn" class="searBtn"></button>
      </div>
    </form>
  </div>
  <?php
  ...
  ?>
  <div id="cit-cont">
    <!-- here goes pics with links to city pages -->
    <?php
    $infoClass = new CreateInfo();
    $infoClass->citiesList();
    ?>
    <!-- -->
  </div>
